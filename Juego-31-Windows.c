...
#define CTRL -1         //Bandera para verificar utilizacion de cartas
#pragma endregion
...
//Procedimiento que detiene el hilo de la ejecución , en este caso implementado con fin estetico
...
{
    char resp[1];
    system("cls"); //Procedimiento para limpiar la consola
...
bool terminarJuego()
{
    ...
    scanf("%1s",resp); //Sin validar
        if(strcmp(resp, "Q") == 0 || strcmp(resp, "q") == 0) return true;
        else if(strcmp(resp, "C") == 0 || strcmp(resp, "c") == 0) return false;
}
#pragma endregion
